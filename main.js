function submit()
{
    ...
    console.log(display_student_array);
    document.getElementById("display_name_with_commas").innerHTML=display-display_student_array;
...
function sorting()
{
    ...
    for(var k=0; k<length_of_name_of_students_array; k++)
    {
        display_student-array-sorting.push("<h4>NAME-"+name_of_the_student_array[k]+"</h4>");
